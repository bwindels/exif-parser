...
describe('DateUtil', () => {
  ...
  it('should parse invalid date without timezone should not return anything', () => {

    const dateStr = '1990:AA:14 14:30:14';
    const timestamp = DateUtil.parseDateWithSpecFormat(dateStr);
    assert.strictEqual(timestamp, undefined);
  });
  it('should parse given date with timezone', () => {
